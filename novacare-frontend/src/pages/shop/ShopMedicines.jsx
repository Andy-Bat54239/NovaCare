...
export default function ShopMedicines() {
  ...
  const filtered = useMemo(() => {
    ...
    switch (sortBy) {
      case 'name-asc':  result = [...result].sort((a, b) => a.brandName.localeCompare(b.brandName)); break;
      case 'name-desc': result = [...result].sort((a, b) => b.brandName.localeCompare(a.brandName)); break;
      case 'price-asc': result = [...result].sort((a, b) => a.price - b.price); break;
      case 'price-desc':result = [...result].sort((a, b) => b.price - a.price); break;
    }
    return result;
  }, [medicines, search, categoryFilter, formFilter, sortBy, rxFilter]);
          ...
          <Link to={`/shop/medicines/${m.id}`} key={m.id} className="product-card">
            ...
            <div className="product-card-body">
              ...
              <div className="product-card-footer">
                <span className="product-price">RWF {Math.round(m.price).toLocaleString()}</span>
