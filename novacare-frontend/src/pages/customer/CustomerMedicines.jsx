...
export default function CustomerMedicines() {
  ...
  const { cartItems, addToCart, updateQuantity, getItemCount, getTotal } =
    useCart();
  ...
  const setMedQty = (id, val) =>
    setQty((prev) => ({ ...prev, [id]: Math.max(1, val) }));
    ...
    <div style={{ paddingBottom: totalItems > 0 ? 90 : 0 }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Browse stock across all NovaCare branches and add to your order
        </p>
      </div>
                  ...
                  {totalStock > 0 && (
                    ...
                    >
                      {inCart > 0 ? (
                        ...
                        >
                          <button
                            onClick={() => updateQuantity(med.id, inCart - 1)}
                            style={{
                              width: 32,
                              height: 32,
                              borderRadius: "50%",
                          ...
                          {med.requiresPrescription &&
                            (() => {
                              ...
                              return cartItem?.prescriptionDataUrl ? (
                                ...
                                >
                                  <FileImage size={13} /> No prescription
                                </span>
                              );
                            })()}
                        </div>
                        ...
                        >
                          ...
                          >
                            <button
                              onClick={() =>
                                setMedQty(med.id, getQty(med.id) - 1)
                              }
                              style={{
                                width: 30,
                                height: 30,
      ...
      {rxModal && (
        ...
        >
          ...
          >
            ...
            >
              <strong>{rxModal.medicine.brandName}</strong> requires a valid
              prescription. Please upload a clear photo or scan of your
              prescription before adding to cart.
            </p>
              ...
              {rxPreview ? (
                ...
                <>
                  ...
                  >
                    {rxFile
                      ? rxFile.name
                      : "Tap to upload · JPG, PNG or PDF · Max 5 MB"}
                  </span>
                </>
              )}
              {rxFile && !rxPreview && (
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 10,
                  border: "none",
                  background: rxFile ? "var(--primary)" : "#e2e8f0",
                  color: rxFile ? "white" : "#94a3b8",
                  fontWeight: 700,
                  fontSize: "0.9rem",
                  cursor: rxFile ? "pointer" : "not-allowed",
                }}
              >
                <ShoppingCart
                  size={15}
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ opacity: 0.8 }}>
              · RWF {Math.round(getTotal()).toLocaleString()}
            </span>
          </div>
          <button
