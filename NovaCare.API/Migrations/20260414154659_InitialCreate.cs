        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId_External = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescriptionFileName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BranchId", "CreatedAt", "Email", "FirstName", "IsActive", "LastName", "PasswordHash", "Role" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@novacare.rw", "Admin", true, "User", "$2a$11$jMB7.6xlZUYdWazmTtIToO8sp1Fv8ls6xPo7G/yTtuCBP/zq8yNdm", 1 },
                    { 2, 1, new DateTime(2025, 2, 15, 9, 0, 0, 0, DateTimeKind.Utc), "rachel@novacare.rw", "Rachel", true, "Green", "$2a$11$Aud1nPFualk4FDnVU5KT/ulvxgUxtSa2mjrlfrasZVKIIB3aZwSPe", 2 },
                    { 3, 2, new DateTime(2025, 3, 1, 9, 0, 0, 0, DateTimeKind.Utc), "marcus@novacare.rw", "Marcus", true, "Lee", "$2a$11$Aud1nPFualk4FDnVU5KT/ulvxgUxtSa2mjrlfrasZVKIIB3aZwSPe", 2 },
                    { 4, 3, new DateTime(2025, 3, 20, 9, 0, 0, 0, DateTimeKind.Utc), "fatima@novacare.rw", "Fatima", true, "Al-Rashid", "$2a$11$Aud1nPFualk4FDnVU5KT/ulvxgUxtSa2mjrlfrasZVKIIB3aZwSPe", 2 },
                    { 5, 1, new DateTime(2025, 4, 10, 9, 0, 0, 0, DateTimeKind.Utc), "james@novacare.rw", "James", true, "Carter", "$2a$11$S7dudiRq230EYCsYZ1Jewe/EZJkb4NEJBMZGui1mJa/EN/KYSfEq.", 3 },
                    { 6, 2, new DateTime(2025, 5, 1, 9, 0, 0, 0, DateTimeKind.Utc), "sophie@novacare.rw", "Sophie", true, "Nguyen", "$2a$11$S7dudiRq230EYCsYZ1Jewe/EZJkb4NEJBMZGui1mJa/EN/KYSfEq.", 3 },
                    { 7, 3, new DateTime(2025, 6, 15, 9, 0, 0, 0, DateTimeKind.Utc), "omar@novacare.rw", "Omar", true, "Hassan", "$2a$11$S7dudiRq230EYCsYZ1Jewe/EZJkb4NEJBMZGui1mJa/EN/KYSfEq.", 3 }
                });
